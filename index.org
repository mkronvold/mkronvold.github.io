...
***** manually or automatically build everything in advance, sync changes as they happen
***** valero replicate all the manifests to dr site
...
***** provision a TKG and CD at DR site and build everything for DR as needed
*** Misc
**** DONE ask about stippen
  + how do they get it approved?
  + how do they know they got it?
*** gitops (manumation) automation of
+ cluster provisioning
+ namespace provisioning
+ post-installation of cluster specific
  - deployments/daemonsets
+ RBAC
**** TODO Decision on what tools to use
+ look at helm?  can you re-run helm periodically to maintain an environment/deployment?
  - helm install vs update
**** TODO how do we update TMC?
+ ask vmware how to use argo with tmc
**** TODO how many to install and where
**** TODO are we sharing with app installs
+ Some apps use Digital AI and helm instead of ArgoCD (watermill)
**** TODO how to add existing clusters into git without recreating everything in production
*** config management vs continuous delivery
**** using ansible to manage files in git?
*** DR
** Old
*** Tanzu Labs
