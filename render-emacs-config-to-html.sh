...
echo "#+SETUPFILE: https://raw.githubusercontent.com/mkronvold/mkronvold.github.io/main/theme-readtheorg.setup" > index.org
cat ${home}/.emacs.d/configuration.org >> index.org
